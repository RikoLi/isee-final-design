...
plt.plot(steps, train_loss, color='red', label='YOLOv3 train loss', marker='.', linewidth='0.5')
plt.plot(val_steps, val_loss, color='blue', label='YOLOv3 val loss', marker='.', linewidth='0.5')
